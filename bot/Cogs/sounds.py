...
FFMPEG_OPTIONS = {'before_options': '-reconnect 1 -reconnect_streamed 1 -reconnect_delay_max 5', 'options': '-vn -report -filter:a "volume=1.5"'}
...
async def play_sound(inter: disnake.ApplicationCommandInteraction, path):
    ...
    voice_client.play(FFmpegOpusAudio.from_probe(path, **FFMPEG_OPTIONS))
