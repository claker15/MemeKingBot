...
class Equipment(commands.Cog):
    ...
    async def upgrade_wand(self, inter: disnake.CommandInteraction):
        ...
        usr_current_points = user_points(inter.guild.id, inter.author.id)
        ...
        if usr_current_points < 50:
            ...
            current_wand = get_user_wand(inter.author.id, inter.guild.id)
            ...
            change_user_wand(new_wand, inter.author.id, inter.guild.id)
