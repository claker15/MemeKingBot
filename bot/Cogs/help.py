...
class king_help(commands.Cog):
    ...
    @commands.slash_command(description="See commands available")
    async def king_help(self, inter: disnake.CommandInteraction):
        embed = disnake.Embed(title="MemeKingBot", description="This is a bot that will crown a meme king every week. The king is the one who posts the most unique memes that week")
